...
import {BringToFront, Split} from "lucide-react";
...
const QueryItemNode = ({id}:{id:string}) => {
        ...
        <div className={"w-36 h-auto border rounded-lg bg-white"}>
            ...
            <div className={"flex items-center justify-between gap-2 border-b px-2 py-1"}>
                <div className={"flex items-center gap-1 text-zinc-600"}>
                    <BringToFront className={"text-indigo-400"} size={10}/>
                    <p className={"text-[10px]"}>Query Item Node</p>
                </div>
